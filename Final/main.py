...
class Main:
    def __init__(self):
        ...
        self.shp_opener = Shp_Opener(f'Data/Data/{chosen_file}/Additional_Data/{shp_file[0]}',f'Data/Data/{chosen_file}/Additional_Data/{transect_file[0]}')
    ...
    def display_path(self,best_path_coors):
        ...
        # example_point = [1661582.8996386123, 5411206.339376066, 800.70099639892578]
        possible_locations = []
        # self.identify_possible_locations(points, possible_locations)

        # print(self.point_cloud.points_visible(example_point,points))
